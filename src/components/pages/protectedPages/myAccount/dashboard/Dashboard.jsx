...
const Dashboard = () => {
   ...
   const { data: userDetailData, refetch } = useGetUserSingleQuery(
      userData?.id,
      { skip: !userData?.id }
   );
                     ...
                     >
                        ...
                        <div>
                           ...
                           <div className="text-[20px] font-[600] text-[#000]">
                              {userDetailData?.data?.carts_count}
                           </div>
                        </div>
                     </div>
                  </Grid>
                  <Grid item xs={12} sm={6} md={4}>
                     ...
                     >
                        ...
                        <div>
                           ...
                           <div className="text-[20px] font-[600] text-[#000]">
                              {userDetailData?.data?.orders_count}
                           </div>
                        </div>
                     </div>
                  </Grid>
                  <Grid item xs={12} sm={6} md={4}>
                     ...
                     >
                        ...
                        <div>
                           ...
                           <div className="text-[20px] font-[600] text-[#000]">
                              {userDetailData?.data?.wishlists_count}
                           </div>
                        </div>
                     </div>
                  </Grid>

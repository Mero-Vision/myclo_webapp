...
import "./CommonSearchProductCard.css";

const CommonSearchProductCard = ({ data, showCards }) => {
      ...
      <>
         {isMobile ? (
            <Grid
               ...
               className="w-[100%] px-[6px] sm:px-[8px] md:px-[10px] lg:px-[10px] py-[10px] rounded-[8px]"
               item
               xs={6}
               sm={4}
               md={4}
            ...
            >
               <div
                  className="flex flex-col cursor-pointer product-card p-[8px] rounded-[6px]"
                  style={{
                     width: "100% !important",
                     boxShadow:
               ...
               >
                  <div className="product-card aspect-[1/1.33] max-h-[300px] rounded-[8px] relative overflow-hidden group mb-[16px]">
...
CommonSearchProductCard.propTypes = {
...
export default CommonSearchProductCard;

...
import "./CommonSimilarProductCard.css";

const CommonSimilarProductCard = ({ data, showCards }) => {
         ...
         {isMobile ? (
            ...
            >
               ...
               >
                  ...
                  <div className="flex gap-[4px] flex-col min-h-[85px]">
                     <div className="titleFive">{data?.name}</div>
...
CommonSimilarProductCard.propTypes = {
...
export default CommonSimilarProductCard;
